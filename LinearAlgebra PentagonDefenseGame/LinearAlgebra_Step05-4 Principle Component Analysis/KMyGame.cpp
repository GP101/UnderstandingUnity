...
void KMyGame::Update(float fElapsedTime_)
{
    ...
    /*virtual*/OnUpdate(fElapsedTime_);
}
...
void KMyGame::ProcessCommand(int commandId)
{
    /*virtual*/OnCommand(commandId);
}
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_COMMAND:
    {
        ...
        case IDM_ABOUT:
            ...
            break;
        case ID_FILE_RESETDATA:
            OnCommand(ID_FILE_RESETDATA);
            break;
        case ID_FILE_DRAWPCA:
            OnCommand(ID_FILE_DRAWPCA);
            break;
        case IDM_EXIT:
            DestroyWindow(hWnd);
            break;
...
void OnCommand(int commandId)
{
    KMyGame::GetInstance()->OnCommand(commandId);
}
