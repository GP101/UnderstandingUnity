...
{
    {
        KVector2 v0 = KVector2(0.0f, float(- numVerticalGrid / 2));
        KVector2 v1 = KVector2(0.0f, float(numVerticalGrid / 2));
        KVectorUtil::DrawLine(hdc, v0, v1, 2, PS_SOLID, color );
    }

    {
        KVector2 v0 = KVector2(float(-numHorizontalGrid / 2), 0.0f);
        KVector2 v1 = KVector2(float(numHorizontalGrid / 2), 0.0f);
        KVectorUtil::DrawLine(hdc, v0, v1, 2, PS_SOLID, color );
    }
}
...
void KVectorUtil::DrawGrid( HDC hdc, int numHorizontalGrid, int numVerticalGrid, COLORREF color)
{
    ...
    for (int count = 0; count <= numHorizontalGrid; ++count) {
        KVector2 v0 = KVector2((float)hbegin, 0.0f) + KVector2(0.0f, float(- numVerticalGrid / 2));
        KVector2 v1 = KVector2((float)hbegin, 0.0f) + KVector2(0.0f, float(numVerticalGrid / 2));
    ...
    for (int count = 0; count <= numVerticalGrid; ++count) {
        KVector2 v0 = KVector2(0.0f,(float)vbegin) + KVector2(float(-numHorizontalGrid / 2), 0.0f);
        KVector2 v1 = KVector2(0.0f, (float)vbegin)+ KVector2( float(numHorizontalGrid / 2), 0.0f);
        KVectorUtil::DrawLine(hdc, v0, v1, 1, PS_DOT, color);
        vbegin += 1;
    }
}
...
void KVectorUtil::ScanDrawPolygon(HDC hdc, std::vector<KVector2>& vertices, COLORREF color)
{
