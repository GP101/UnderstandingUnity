...
void KPolygonShape::SetRotation(double radians)
{
...
void KPolygonShape::SetBox(double hw, double hh)
{
	//m_vertexCount = 4;
	m_vertices.resize(4);
	m_normals.resize(4);
...
void KPolygonShape::Transform(const KMatrix3& transform)
{
	for (KVector2& v : m_vertices)
	{
		v = transform * v;
	}
}
