    ...
    for(int i = 0; i < primitiveCounter; ++i)
    {
        ...
        if(isVisible == true)
        {
            KVectorUtil::FillTriangle( hdc
                , (int)m_vertexBuffer[i0].pos.x, (int)m_vertexBuffer[i0].pos.y, color, m_vertexBuffer[i0].pos.z
                , (int)m_vertexBuffer[i1].pos.x, (int)m_vertexBuffer[i1].pos.y, color, m_vertexBuffer[i1].pos.z
    ...
    , Bitmap& bitmap ) // texture buffer
{
    ...
    for(int i = 0; i < primitiveCounter; ++i)
    {
        ...
        KVector3 forward( 0, 0, -1 );
        float dot = Dot( forward, normal );
        float shade = __max(0.f, Dot(light.m_dir, normal));
        const bool isVisible = ( dot > 0 );
        ...
        uv[0][0] = m_vertexBuffer[i0].u;
        uv[0][1] = m_vertexBuffer[i0].v;
        uv[0][2] = 0.0f;
        uv[1][0] = m_vertexBuffer[i1].u;
        uv[1][1] = m_vertexBuffer[i1].v;
        uv[1][2] = 0.0f;
        uv[2][0] = m_vertexBuffer[i2].u;
        uv[2][1] = m_vertexBuffer[i2].v;
        uv[2][2] = 0.0f;
        ...
        {
            KVectorUtil::FillTriangle( hdc
                , (int)m_vertexBuffer[i0].pos.x, (int)m_vertexBuffer[i0].pos.y, uv[0], m_vertexBuffer[i0].pos.z
                , (int)m_vertexBuffer[i1].pos.x, (int)m_vertexBuffer[i1].pos.y, uv[1], m_vertexBuffer[i1].pos.z
...
{
    m_vertexBuffer[0] = KVertex{ KVector3( -20.f, -20.f, +20.f ), 0.0f, 1.0f };
    m_vertexBuffer[1] = KVertex{ KVector3( -20.f, +20.f, +20.f ), 0.0f, 0.0f };
    m_vertexBuffer[2] = KVertex{ KVector3( +20.f, +20.f, +20.f ), 1.0f, 0.0f };
    m_vertexBuffer[3] = KVertex{ KVector3( +20.f, -20.f, +20.f ), 1.0f, 1.0f };
    m_vertexBuffer[4] = KVertex{ KVector3( -20.f, -20.f, -20.f ), 0.0f, 1.0f };
    m_vertexBuffer[5] = KVertex{ KVector3( -20.f, +20.f, -20.f ), 0.0f, 0.0f };
    m_vertexBuffer[6] = KVertex{ KVector3( +20.f, +20.f, -20.f ), 1.0f, 0.0f };
    m_vertexBuffer[7] = KVertex{ KVector3( +20.f, -20.f, -20.f ), 1.0f, 1.0f };

    m_vertexBuffer[8] = KVertex{ KVector3( -20.f, +20.f, -20.f ), 0.0f, 1.0f };
    m_vertexBuffer[9] = KVertex{ KVector3( +20.f, +20.f, -20.f ), 0.0f, 0.0f };
    m_vertexBuffer[10] = KVertex{ KVector3( +20.f, +20.f, +20.f ), 1.0f, 0.0f };
    m_vertexBuffer[11] = KVertex{ KVector3( -20.f, +20.f, +20.f ), 1.0f, 1.0f };
    m_vertexBuffer[12] = KVertex{ KVector3( -20.f, -20.f, -20.f ), 0.0f, 1.0f };
    m_vertexBuffer[13] = KVertex{ KVector3( +20.f, -20.f, -20.f ), 0.0f, 0.0f };
    m_vertexBuffer[14] = KVertex{ KVector3( +20.f, -20.f, +20.f ), 1.0f, 0.0f };
    m_vertexBuffer[15] = KVertex{ KVector3( -20.f, -20.f, +20.f ), 1.0f, 1.0f };

    m_vertexBuffer[16] = KVertex{ KVector3( -20.f, -20.f, -20.f ), 0.0f, 1.0f };
    m_vertexBuffer[17] = KVertex{ KVector3( -20.f, +20.f, -20.f ), 0.0f, 0.0f };
    m_vertexBuffer[18] = KVertex{ KVector3( -20.f, +20.f, +20.f ), 1.0f, 0.0f };
    m_vertexBuffer[19] = KVertex{ KVector3( -20.f, -20.f, +20.f ), 1.0f, 1.0f };
    m_vertexBuffer[20] = KVertex{ KVector3( +20.f, -20.f, -20.f ), 0.0f, 1.0f };
    m_vertexBuffer[21] = KVertex{ KVector3( +20.f, +20.f, -20.f ), 0.0f, 0.0f };
    m_vertexBuffer[22] = KVertex{ KVector3( +20.f, +20.f, +20.f ), 1.0f, 0.0f };
    m_vertexBuffer[23] = KVertex{ KVector3( +20.f, -20.f, +20.f ), 1.0f, 1.0f };
