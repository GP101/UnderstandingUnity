...
DWORD                   g_dwNumIndices = 36;
DWORD                   g_dwNumVertices = 24;
...
HRESULT InitGeometry()
{
    ...
    if( FAILED( D3DXCreateTextureFromFile( g_pd3dDevice, L"imageService.jpg", &g_pTexture ) ) )
    {
    ...
    if( FAILED( g_pd3dDevice->CreateVertexBuffer( g_dwNumVertices * sizeof( CUSTOMVERTEX ),
    ...
    if( FAILED( g_pVB->Lock( 0, 0, ( void** )&pVertices, 0 ) ) )
        return E_FAIL;
    pVertices[0] = CUSTOMVERTEX{ D3DXVECTOR3( -40.f, +40.f, -40.f ), 0xffffffff, 0.0f, 1.0f };
    pVertices[1] = CUSTOMVERTEX{ D3DXVECTOR3( -40.f, -40.f, -40.f ), 0xffffffff, 0.0f, 0.0f };
    pVertices[2] = CUSTOMVERTEX{ D3DXVECTOR3( +40.f, -40.f, -40.f ), 0xffffffff, 1.0f, 0.0f };
    pVertices[3] = CUSTOMVERTEX{ D3DXVECTOR3( +40.f, +40.f, -40.f ), 0xffffffff, 1.0f, 1.0f };
    pVertices[4] = CUSTOMVERTEX{ D3DXVECTOR3( -40.f, +40.f, +40.f ), 0xffffffff, 0.0f, 1.0f };
    pVertices[5] = CUSTOMVERTEX{ D3DXVECTOR3( -40.f, -40.f, +40.f ), 0xffffffff, 0.0f, 0.0f };
    pVertices[6] = CUSTOMVERTEX{ D3DXVECTOR3( +40.f, -40.f, +40.f ), 0xffffffff, 1.0f, 0.0f };
    pVertices[7] = CUSTOMVERTEX{ D3DXVECTOR3( +40.f, +40.f, +40.f ), 0xffffffff, 1.0f, 1.0f };

    pVertices[8] = CUSTOMVERTEX{ D3DXVECTOR3( -40.f, -40.f, +40.f ), 0xffffffff, 0.0f, 1.0f };
    pVertices[9] = CUSTOMVERTEX{ D3DXVECTOR3( +40.f, -40.f, +40.f ), 0xffffffff, 0.0f, 0.0f };
    pVertices[10] = CUSTOMVERTEX{ D3DXVECTOR3( +40.f, -40.f, -40.f ), 0xffffffff, 1.0f, 0.0f };
    pVertices[11] = CUSTOMVERTEX{ D3DXVECTOR3( -40.f, -40.f, -40.f ), 0xffffffff, 1.0f, 1.0f };
    pVertices[12] = CUSTOMVERTEX{ D3DXVECTOR3( -40.f, +40.f, +40.f ), 0xffffffff, 0.0f, 1.0f };
    pVertices[13] = CUSTOMVERTEX{ D3DXVECTOR3( +40.f, +40.f, +40.f ), 0xffffffff, 0.0f, 0.0f };
    pVertices[14] = CUSTOMVERTEX{ D3DXVECTOR3( +40.f, +40.f, -40.f ), 0xffffffff, 1.0f, 0.0f };
    pVertices[15] = CUSTOMVERTEX{ D3DXVECTOR3( -40.f, +40.f, -40.f ), 0xffffffff, 1.0f, 1.0f };

    pVertices[16] = CUSTOMVERTEX{ D3DXVECTOR3( -40.f, +40.f, +40.f ), 0xffffffff, 0.0f, 1.0f };
    pVertices[17] = CUSTOMVERTEX{ D3DXVECTOR3( -40.f, -40.f, +40.f ), 0xffffffff, 0.0f, 0.0f };
    pVertices[18] = CUSTOMVERTEX{ D3DXVECTOR3( -40.f, -40.f, -40.f ), 0xffffffff, 1.0f, 0.0f };
    pVertices[19] = CUSTOMVERTEX{ D3DXVECTOR3( -40.f, +40.f, -40.f ), 0xffffffff, 1.0f, 1.0f };
    pVertices[20] = CUSTOMVERTEX{ D3DXVECTOR3( +40.f, +40.f, +40.f ), 0xffffffff, 0.0f, 1.0f };
    pVertices[21] = CUSTOMVERTEX{ D3DXVECTOR3( +40.f, -40.f, +40.f ), 0xffffffff, 0.0f, 0.0f };
    pVertices[22] = CUSTOMVERTEX{ D3DXVECTOR3( +40.f, -40.f, -40.f ), 0xffffffff, 1.0f, 0.0f };
    pVertices[23] = CUSTOMVERTEX{ D3DXVECTOR3( +40.f, +40.f, -40.f ), 0xffffffff, 1.0f, 1.0f };
    g_pVB->Unlock();
...
VOID SetupMatrices()
{
    ...
    D3DXVECTOR3 vEyePt( 0.0f, 100.0f,-200.0f );
