    ...
    for(int i = 0; i < primitiveCounter; ++i)
    {
        ...
        if(isVisible == true)
        {
            KVectorUtil::FillTriangle(hdc
                , (int)m_vertexBuffer[i0].pos.x, (int)m_vertexBuffer[i0].pos.y, color[0]
                , (int)m_vertexBuffer[i1].pos.x, (int)m_vertexBuffer[i1].pos.y, color[1]
                , (int)m_vertexBuffer[i2].pos.x, (int)m_vertexBuffer[i2].pos.y, color[2] );
