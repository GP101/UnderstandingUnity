...
{
    m_vertexBuffer[0] = KVector3(   0.0f, 10.0f, 0.0f);
    m_vertexBuffer[1] = KVector3(   0.0f,   0.0f, 0.0f);
    m_vertexBuffer[2] = KVector3( 10.0f,   0.0f, 0.0f);
    m_vertexBuffer[3] = KVector3( 10.0f, 10.0f, 0.0f);
    m_sizeVertex = 4;
